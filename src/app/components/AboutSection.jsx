        ...
        {sections.map((section, index) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xl mx-2 font-thin">
                {section.description}
              </p>
            </div>
            ...
            <div className="flex-1">
              <Image
                ...
                alt={section.title}
                className="rounded-3xl shadow-lg shadow-brandGray"
